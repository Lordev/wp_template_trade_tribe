...
<div class="position-absolute top-50 translate-middle-y">
    ...
    <div class="position-absolute top-50 start-50 translate-middle d-flex gap-12">
        <button class="slider-button bg-transparent border-0" type="button" title="left arrow" id=<?php echo $btn_prev_id ?>>
            <svg width="109" Zeight="108" viewBox="0 0 109 108" fill="none" xmlns="http://www.w3.org/2000/svg" class="cursor">
